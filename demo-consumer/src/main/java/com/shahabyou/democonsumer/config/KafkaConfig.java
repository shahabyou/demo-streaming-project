package com.shahabyou.democonsumer.config;
import java.util.HashMap;
import java.util.Map;

import com.shahabyou.democonsumer.service.ConsumerKafkaService;
...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerKafkaService listener() {
        return new ConsumerKafkaService();
    }
